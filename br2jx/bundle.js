...
var _VotesBlock = __webpack_require__(30);

var _VotesBlock2 = _interopRequireDefault(_VotesBlock);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var questionText = 'Чем чаще празднует Лицей <br> Свою святую годовщину,<br> Тем робче старый круг друзей <br> В семью стесняется едину,<br>Тем реже он; тем праздник наш';
...
*/
var aa=__webpack_require__(9),ba=__webpack_require__(1),m=__webpack_require__(10),p=__webpack_require__(11),v=__webpack_require__(5),da=__webpack_require__(12),ea=__webpack_require__(13),fa=__webpack_require__(14),ha=__webpack_require__(15);
...
var VotesBlock = function (_React$Component) {
  ...
  _createClass(VotesBlock, [{
    ...
    value: function render() {
      ...
      var s = 'Чем чаще празднует Лицей <br> Свою святую годовщину,<br> Тем робче старый круг друзей <br> В семью стесняется едину,<br>Тем реже он; тем праздник наш';
      var g = s.split("<br>");
      g.forEach(answer, function (i) {
        var jsx = [];
        if (answer[i] != 0) {
          jsx.push("<br>");
        } else {
      ...
      // 	.forEach(r,i=>{if (i!=0){ jsx.push("<br>")}
      //  jsx.push(r)});
